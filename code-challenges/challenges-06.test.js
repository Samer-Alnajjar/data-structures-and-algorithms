...
// [x]Sort the array of objects (characters) by number of children(fewest to most).
//    -[x]use the .sort() for the children in the array
// [x]If the house has the same number of children sort alphabetically.
//    -[x]use the .sort() for the first letters for children in the array
...
// [x]Write a function to pass an object
// [x]and it will return an array of the properties of that object
...
------------------------------------------------------------------------------------------------ */
// [x]Write a function named checkValues that takes an object and value.
// [x]Return true if the value is an object

const checkValues = (obj, value) => {
  // Solution code here...

  // (Has an idea about includes)
...
//   const newArr = [];
//    newArr.length = arrOfKeys.length
//    for(let i = 0; i < newArr.length; i++) {
//     newArr[i] = arrOfKeys[i] + ": " + arrOfValues[i]; 
//    }
//    return newArr;
// }
